...
function GraphCard({ logo, className, bpm, tonicHz, tonicLabel, swaraGuides, showFrequencyDiagram, showPhrasing, canRecord, hasShrutiSet, hasRagamSet, hasTalamSet, shrutiButtonLabel, talamButtonLabel, ragamButtonLabel, onBpmChange, onOpenPopup, onRecordingStateChange }) {
